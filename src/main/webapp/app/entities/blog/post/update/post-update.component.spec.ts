...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 20160 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 25929 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 12107 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 27044 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 23576 };
      post.blog = blog;
      const tag: ITag = { id: 3751 };
      post.tags = [tag];
