...
describe('Blog e2e test', () => {
  ...
  const blogSample = { name: 'the', handle: 'calmly now and' };
  ...
  describe('new Blog page', () => {
    ...
    it('should create an instance of Blog', () => {
      cy.get(`[data-cy="name"]`).type('ram toward concrete');
      cy.get(`[data-cy="name"]`).should('have.value', 'ram toward concrete');

      cy.get(`[data-cy="handle"]`).type('who');
      cy.get(`[data-cy="handle"]`).should('have.value', 'who');
