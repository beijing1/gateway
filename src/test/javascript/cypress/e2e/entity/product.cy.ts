...
describe('Product e2e test', () => {
  ...
  const productSample = { title: 'draught only', price: 10074.39 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="title"]`).type('gadzooks wiggly next');
      cy.get(`[data-cy="title"]`).should('have.value', 'gadzooks wiggly next');

      cy.get(`[data-cy="price"]`).type('16016.12');
      cy.get(`[data-cy="price"]`).should('have.value', '16016.12');
