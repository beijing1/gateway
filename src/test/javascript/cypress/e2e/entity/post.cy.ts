...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'round', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-04-19T14:01:19.998Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('admire');
      cy.get(`[data-cy="title"]`).should('have.value', 'admire');
      ...
      cy.get(`[data-cy="date"]`).type('2024-04-18T19:09');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-04-18T19:09');
